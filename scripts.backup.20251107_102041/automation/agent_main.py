...
def mode_hook(validator_name: str) -> int:
    ...
    Args:
        validator_name: Name of validator (malicious-behavior, command-guard, code-quality-core,
                        code-quality-python, response-scanner, shebang-check, todo-validator)
...
def main() -> int:
    ...
    parser.add_argument(
        "--hook",
        metavar="VALIDATOR",
        help="Hook validator mode (malicious-behavior, command-guard, code-quality-core, code-quality-python, response-scanner, shebang-check, todo-validator)",
    )
