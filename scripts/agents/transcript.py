...
def is_actual_user_message(line: str) -> bool:
    ...
    if isinstance(content, str):
        ...
        return not content.startswith(("[Request interrupted", "Stop hook feedback:", "# COMPLETION VALIDATION"))

    # Handle array content (tool results and other structured content)
    if isinstance(content, list):
