...
from scripts.agents.sync import SyncAttempt, SyncExecutor, SyncResult
...
class TestSyncExecutor:
    ...
    def executor(self, mock_config: Mock) -> Generator[SyncExecutor, None, None]:
        ...
        with (
            patch("scripts.agents.sync.get_config") as mock_get_config,
            patch("scripts.agents.sync.get_agent_cli") as mock_get_cli,
        ):
